import math
# to get access# to math variables and functions
import csv # to get access to
#csv reading/writing function
...
#FUNCTIONS
#a named seguence of statements
#we have been using pre-definedfunctions
...
#task:remove the list from table
#and store in a variable called header
#hint for the task: https://docs.python.org/3/tutorial/datastructures.html
header = table.pop(0)
print("header:",header)
print("table:")
print(table)
